...
public class RegisterWithRequiredUsername extends TestBase {

    @Test(priority = 1)
    public void registerWithRequiredUsername()  {
      ...
      //registerPage.enterUsername("x_9");
        ...
        Assert.assertTrue(registerPage.verifyUsernameRequiredError());
    }
}
