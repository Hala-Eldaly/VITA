...
public class RegisterWithRequiredMaritalStatus extends TestBase {

    @Test(priority = 9)
    public void registerWithRequiredMaritalStatus()  {
      ...
      //registerPage.selectMaritalStatus("Single"); 
        ...
        Assert.assertTrue(registerPage.verifyGenderRequiredError());
