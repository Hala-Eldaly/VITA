...
public class RegisterWithRequiredPhoneNumber extends TestBase {

    @Test(priority = 1)
    public void registerWithRequiredPhoneNumber()  {
      ...
      //registerPage.enterPhone("01586700650"); 
        ...
        Assert.assertTrue(registerPage.verifyPhoneRequiredError());
    }
}
