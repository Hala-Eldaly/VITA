...
public class RegisterWithRequiredFullName extends TestBase {

    @Test(priority = 1)
    public void registerWithRequiredFullName()  {
      ...
      //registerPage.enterFullName("kkk"); 
        ...
        Assert.assertTrue(registerPage.verifyFullNameRequiredError());
    }
}
